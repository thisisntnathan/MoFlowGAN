...
class GraphConvolution(nn.Module):
    def __init__(self, in_features, graph_conv_units, edge_type_num, with_features=False, f_dim=0, dropout_rate=0.):
        ...
        self.multi_graph_convolution_layers = MultiGraphConvolutionLayers(in_features, 
                self.graph_conv_units, self.activation_f, edge_type_num, with_features, f_dim, dropout_rate)
...
class GraphAggregation(nn.Module):
    ...
    def forward(self, n_tensor, out_tensor, h_tensor=None):
        ...
        # The i here seems to be an attention score.
